...
import DefaultList from '../../board/components/skins/default/List'; // 기본 스킨
import GalleryList from '../../board/components/skins/gallery/List'; // 갤러리 스킨
import ListMain from '../../board/components/skins/default/ListMain';
...
const MyBoardListContainer = ({ setPageTitle, bid }) => {
...
export default React.memo(MyBoardListContainer);
